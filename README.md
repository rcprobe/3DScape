...
- Reproducible artifacts: PLY point clouds, occupancy grids, run manifests, and standalone HTML viewers.
...
8. Exports point clouds, occupancy grids, run manifests, and browser viewers.
